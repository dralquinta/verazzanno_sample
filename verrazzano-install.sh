...
kubectl --kubeconfig=$HOME/.kube/cluster2\_config label namespace default verrazzano-managed=true istio-injection=enabled
kubectl --kubeconfig=$HOME/.kube/cluster2\_config create namespace hello-helidon
kubectl --kubeconfig=$HOME/.kube/cluster2\_config label namespace hello-helidon verrazzano-managed=true istio-injection=enabled
...
kubectl --kubeconfig=$HOME/.kube/cluster0\_config apply \
     -n hello-helidon -f https://raw.githubusercontent.com/verrazzano/verrazzano/v1.3.3/examples/multicluster/hello-helidon/hello-helidon-comp.yaml
...
kubectl --kubeconfig=$HOME/.kube/cluster1 wait \
